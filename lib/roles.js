export const ROLES = {
  ...
  shooter: "Videographer / Shoot",
  client: "Doctor (Client)",
};
// Roles an admin can assign (super_admin is set in the database only)
export const ASSIGNABLE_ROLES = ["admin", "editor", "writer", "designer", "shooter", "client"];
...
export const isStaff = (roles) =>
  ["super_admin", "admin", "editor", "writer", "designer", "shooter"].some((r) => hasRole(roles, r));
